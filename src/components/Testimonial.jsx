  ...
  return (
    <section>
      <div className="container px-5 py-24 mx-auto">
        <h1 className="text-darkSecondary text-center text-3xl lg:text-4xl font-bold mb-8">What our cutomers had to say</h1>
        <div className="flex flex-wrap -m-4">
          <div className="p-4 md:w-1/2 w-full relative">
            <div className="h-full bg-primary  p-8 rounded">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="#413531" className="block w-5 h-5 text-gray-400 mb-4" viewBox="0 0 975.036 975.036">
              ...
              <a className="inline-flex items-center">
                ...
                <span className="flex-grow flex flex-col pl-4">
                  ...
                  <span className="text-darkSecondary text-sm">UI DEVELOPER</span>
                </span>
              </a>
            </div>
          </div>
            ...
            <div className="h-full bg-secondary p-8 rounded">
              ...
              <a className="inline-flex items-center">
                ...
                <span className="flex-grow flex flex-col pl-4">
                  ...
                  <span className="text-darkSecondary text-sm">DESIGNER</span>
                </span>
              </a>
            </div>
          </div>
