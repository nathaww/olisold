  ...
  return (
    <section>
      <div className="container px-5 py-24 mx-auto">
        <h1 className="text-darkSecondary text-center text-3xl lg:text-4xl font-bold mb-8">
        ...
        <div className="flex flex-wrap -m-4">
          ...
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-darkPrimary p-8 rounded">
              ...
              <p className="leading-relaxed mb-6 text-white">Oli’s knit 🧶, I see an amazing potential that can make a change in a fashion industry,
